...
const Introduction = (props) => {
  ...
  const textFarsi = (
    <p className="sm:w-3/4 lg:px-8 px-4 lg:pt-4 pt-2 text-center lg:leading-9 sm:leading-6 text-sm">
...
const textEnghlish =(<p dir="ltr" className="sm:w-3/4 lg:px-8 px-4 lg:pt-4 pt-2 text-center lg:leading-6 sm:leading-4 text-sm">
    ...
    <div className={props.className}>
      ...
      >
        <img
          ...
          alt="background"
        />
        <div className="absolute lg:top-4 sm:0 w-full flex flex-col justify-center items-center font-Vazirmatn">
