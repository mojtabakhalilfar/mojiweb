...
const Layout = (props) => {
  ...
  const hideNavbar = "z-19 sm:hidden lg:sticky sm:absolute sm:top-0 sm:right-0 lg:block lg:w-1/5 h-h-fit bg-gray-100 dark:bg-black flex items-start justify-center flex-col overflow-hidden " 
  const blockNavbar = "z-10 sm:block lg:sticky sm:absolute sm:top-0 sm:right-0 lg:block lg:w-1/5 h-fit bg-gray-100 dark:bg-black flex items-start justify-center flex-col overflow-hidden " 
  return (
    <div className={darkmood ? "dark" : null}>
      <div className="flex flex-col w-screeenh h-fit bg-gray-100 dark:bg-black">
        ...
        <div className="mt-16 z-1 relative h- flex items-start justify-start w-full rounded dark:text-white dark:bg-black bg-gray-100 text-black">
          ...
          <main className="sm:w-full lg:w-4/5 h-fit bg-gray-100 dark:bg-black flex items-start justify-center">
            {props.children}
          </main>
        </div>
      </div>
